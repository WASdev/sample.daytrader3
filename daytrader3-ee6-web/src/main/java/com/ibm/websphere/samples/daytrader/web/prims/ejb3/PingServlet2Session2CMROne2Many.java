 ...
 * will generate a random userID and get the profile for that user using a {@link trade.Account} Entity EJB This tests the common path of a Servlet
 * calling a Session to Entity EJB to get CMR One to One data
 * 
 */
@WebServlet(name = "ejb3.PingServlet2Session2CMROne2Many", urlPatterns = { "/ejb3/PingServlet2Session2CMROne2Many" })
public class PingServlet2Session2CMROne2Many extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        output.append("<html><head><title>Servlet2Session2CMROne2One</title></head>" + "<body><HR><FONT size=\"+2\" color=\"#000066\">PingServlet2Session2CMROne2Many<BR></FONT>"

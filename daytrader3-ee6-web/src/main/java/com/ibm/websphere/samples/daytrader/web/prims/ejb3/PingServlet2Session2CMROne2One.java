 ...
 * 
 */
@WebServlet(name = "ejb3.PingServlet2Session2CMROne2One", urlPatterns = { "/ejb3/PingServlet2Session2CMROne2One" })
public class PingServlet2Session2CMROne2One extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        output.append("<html><head><title>Servlet2Session2CMROne2One</title></head>" + "<body><HR><FONT size=\"+2\" color=\"#000066\">PingServlet2Session2CMROne2One<BR></FONT>"

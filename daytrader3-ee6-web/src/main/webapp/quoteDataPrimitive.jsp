...
<body>
<%@ page import="com.ibm.websphere.samples.daytrader.*,com.ibm.websphere.samples.daytrader.util.*" session="false" isThreadSafe="true" isErrorPage="false"%>
<%! int hitCount = 0;
...
<HR>
<BR>
<FONT size="+2" color="#000066">Quote Data Primitive (PingServlet2Session2EntityJSP):<BR>
</FONT><FONT size="+1" color="#000066">Init time: <%= initTime %></FONT>
<% hitCount++; %>
<P><B>Hit Count: <%= hitCount %></B></P>
<HR>Quote Information<BR><BR><%= quoteData.toHTML() %>
</body>
</html>
